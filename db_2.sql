...
SELECT name, population/1000000 AS 'population(mil)' FROM world  WHERE continent = 'South America';
...
SELECT name, ROUND(population/1000000,2) AS 'pop(millions)', ROUND(GDP/1000000000,2) AS 'GDP(billions)' FROM world WHERE continent = 'South America';
